---
description: "A go-to playbook for regression problems: the EDA-to-baseline workflow, which model to pick when, and which algorithms actually need feature scaling."
domain: ml
type: reference
status: digested
tags:
