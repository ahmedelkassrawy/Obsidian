---
description: "Chapter 2 notes: which problems suit ML, how to map ML metrics to business metrics, and the four requirements of an ML system (reliable, scalable, maintainable, adaptable)."
domain: ml
type: book
status: digested
tags:
