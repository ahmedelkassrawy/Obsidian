---
description: "Study guide on the three assets of ML software (data, model, code): data and ML pipeline stages, the four ML architectural patterns, and model serialization formats."
domain: ml
type: concept
status: digested
tags:
