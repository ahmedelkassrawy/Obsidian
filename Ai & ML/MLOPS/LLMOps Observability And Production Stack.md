---
description: "Notes on LLMOps in production: which LLM metrics to monitor, the observability layers, LLM routing, feedback loops, versioning strategy, and cost and privacy controls."
domain: ml
type: concept
status: digested
tags:
