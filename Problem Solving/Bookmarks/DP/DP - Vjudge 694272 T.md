---
description: "Recursive C++ DP for problem T, with a short note in Arabic explaining that the naive direction TLEs so the recurrence is flipped to go from the fixed value to the variable one."
domain: cs
type: solution
status: digested
tags:
