---
description: "Recursive C++ DP over bracket sequences: track the running open-bracket balance, and a balance of zero means one group has closed and a new one starts."
domain: cs
type: solution
status: raw
tags:
