---
description: "C++ solution that defines a point struct with x, y and z, stores the points in an array, and works over them; includes a short Arabic walkthrough of the struct."
domain: cs
type: solution
status: digested
tags:
  ...
  - topic/c-language
aliases:
  - "3D - Codeforces ICPC Mansoura - Struct"
hubs:
  - "[[C++ Language]]"
---
```C++
