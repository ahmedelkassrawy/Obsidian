---
description: "C++ Kahn's-algorithm solution: push every node with indegree 0 into a queue, peel them off in order, and report a cycle when the topological order is short."
domain: cs
type: solution
status: raw
tags:
