---
description: "The one BFS bookmark with a real write-up: restates the input (n nodes, m edges, k special nodes), explains running BFS from each special node to fill dist[k][i], and then how the k smallest distances are combined."
domain: cs
type: solution
status: digested
tags:
