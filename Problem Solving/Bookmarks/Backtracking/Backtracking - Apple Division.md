---
description: "C++ recursive pick/don't-pick solution that splits apple weights into two groups with the smallest possible difference."
domain: cs
type: solution
status: raw
tags:
...
aliases:
  - "Apple division -- Recursion & Backtarcking"
  - "Apple Division"
  - "CSES"
hubs:
