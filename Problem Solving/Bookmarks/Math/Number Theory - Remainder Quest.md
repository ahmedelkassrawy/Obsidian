---
description: "C++ modular-arithmetic solution with an Arabic walkthrough: read the number as a string, walk it from the last digit to the first, and keep powers of ten under the modulus as you go."
domain: cs
type: solution
status: digested
tags:
