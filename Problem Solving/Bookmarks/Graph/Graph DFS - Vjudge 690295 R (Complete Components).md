---
description: "C++ DFS that counts the edges and vertices inside each connected component and calls the component complete when the counts match the clique formula."
domain: cs
type: solution
status: raw
tags:
