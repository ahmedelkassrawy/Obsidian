---
description: "C++ double-DFS that finds the tree diameter: DFS from node 0 to the farthest node, then DFS again from there for the longest path."
domain: cs
type: solution
status: raw
tags:
