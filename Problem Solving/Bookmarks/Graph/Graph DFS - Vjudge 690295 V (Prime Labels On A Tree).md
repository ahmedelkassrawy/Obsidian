---
description: "C++ tree solution with an Arabic write-up of the reasoning: the tree has to stay linear so that assigning prime numbers keeps every node's sum correct."
domain: cs
type: solution
status: digested
tags:
