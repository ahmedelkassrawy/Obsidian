---
description: "C++ DFS that groups stars into constellations: two stars are joined when their squared Euclidean distance is within the limit, then DFS counts the connected components."
domain: cs
type: solution
status: raw
tags:
