---
description: "C++ solution that decides whether a directed graph is a tree: exactly one node with in-degree 0, then DFS to confirm it is connected and acyclic."
domain: cs
type: solution
status: raw
tags:
