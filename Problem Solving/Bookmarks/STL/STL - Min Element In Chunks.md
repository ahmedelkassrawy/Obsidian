---
description: "C++ solution walking the array in chunks of size K and taking min_element of each chunk; the note explains how dereferencing the min_element iterator works."
domain: cs
type: solution
status: digested
tags:
