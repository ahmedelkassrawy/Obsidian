---
description: "C++ solution that marks shot positions, counts the still-valid ship segments, and binary searches for the first shot that makes the board invalid."
domain: cs
type: solution
status: raw
tags:
