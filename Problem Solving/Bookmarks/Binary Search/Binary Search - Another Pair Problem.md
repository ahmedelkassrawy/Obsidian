---
description: "C++ solution that counts, for each index i, how many earlier indices satisfy the condition by binary searching a sorted list of valid indices."
domain: cs
type: solution
status: raw
tags:
  ...
  - topic/binary-search
aliases:
  - "Another Pair Problem - Binary Search"
hubs:
  - "[[Binary Search]]"
---
