---
description: "Finding all divisors by pairing around sqrt(n), three versions of prime factorisation, and the sieve used to preprocess primes so factorising becomes fast."
domain: cs
type: concept
status: digested
tags:
