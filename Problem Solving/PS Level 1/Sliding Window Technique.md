---
description: "The sliding window: fixed vs variable windows, how the window moves, and - importantly - which subarray problems are NOT sliding window (prefix sum plus hash map instead)."
domain: cs
type: concept
status: digested
tags:
