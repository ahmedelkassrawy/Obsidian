---
description: "Archived code dump: per-bit prefix sums over an array (prefixBits[64][n+1]) for answering bit-count queries on ranges."
domain: cs
type: reference
status: raw
tags:
  ...
  - topic/bitmask
aliases:
  - "_archived_Bit Represeentation,Bitmask,Bitwise"
hubs:
  - "[[Bitmask]]"
---
```C++
