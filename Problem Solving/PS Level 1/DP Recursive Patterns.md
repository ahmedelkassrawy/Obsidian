---
description: "Recursive DP with memoisation, worked through Fibonacci, minimum path sum in a grid, counting paths under a sum constraint, knapsack, and LCS with reconstruction."
domain: cs
type: concept
status: digested
tags:
