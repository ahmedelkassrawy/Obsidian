---
description: "The modular arithmetic toolkit: the % operator and its identities, divisor preprocessing, binary exponentiation, GCD and extended GCD, LCM and the modular inverse."
domain: cs
type: concept
status: digested
tags:
