---
description: "Code-only notes showing with id() that a numpy array sits contiguously in memory while a list does not, and what happens when types are mixed."
domain: cs
type: course
status: raw
tags:
