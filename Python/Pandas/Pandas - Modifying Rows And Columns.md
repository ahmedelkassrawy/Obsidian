---
description: "Code-only notes on renaming columns in bulk (list assignment, comprehension, str.replace, rename) and updating row values."
domain: cs
type: course
status: raw
tags:
