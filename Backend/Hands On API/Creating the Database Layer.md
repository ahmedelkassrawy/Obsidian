---
description: "Book chapter building the data layer: the three layers, the models file with Player/Performance/League/Team relationships, and the database config."
domain: backend
type: book
status: digested
tags:
