---
description: "A fixed six-step method for attacking any system design prompt, plus the latency numbers and back-of-envelope estimation math behind steps 2-5."
domain: backend
type: howto
status: digested
tags:
