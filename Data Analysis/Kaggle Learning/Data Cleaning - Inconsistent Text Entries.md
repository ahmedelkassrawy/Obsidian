---
description: "Fixing inconsistent text entries: inspecting unique values, normalizing case and whitespace, and using fuzzy matching to collapse near-duplicate strings."
domain: ml
type: howto
status: digested
tags:
  ...
  - topic/pandas
aliases:
  - "Data Cleaning.4 Inconsistent Data"
  - "Data Cleaning.4"
  - "fuzzy matching"
  - "fuzzywuzzy"
  - "inconsistent text"
