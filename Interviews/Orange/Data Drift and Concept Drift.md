---
description: "The difference between data drift (inputs shift) and concept drift (the input-to-output relationship shifts), how each is detected, and why continuous training is the fix."
domain: career
type: interview
status: digested
tags:
