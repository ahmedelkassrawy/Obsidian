---
description: "A numbered list of basic pandas exploration calls (columns, dtypes, isnull().sum(), describe) repeated across the DonorsChoose dataset tables."
domain: ml
type: reference
status: raw
tags:
...
aliases:
  - "pandas cheatsheet"
  - "columns dtypes isnull describe"
hubs:
  - "[[Pandas]]"
---
