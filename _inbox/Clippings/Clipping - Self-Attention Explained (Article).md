---
description: "Clipped explainer with inline SVG diagrams on self-attention: the context problem, what queries, keys and values are, and how the attention score is computed and combined."
domain: ml
type: clipping
status: raw
tags:
