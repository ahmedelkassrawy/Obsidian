---
description: "The Mini-RAG project stack (multilingual embeddings, Qdrant plus Postgres, Langfuse, PyMuPDF4llm) followed by the Postgres and SQLAlchemy conventions the project follows, including Alembic setup and async record creation."
domain: ai-eng
type: project
status: digested
tags:
