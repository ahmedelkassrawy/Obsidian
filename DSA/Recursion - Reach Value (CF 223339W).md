---
description: "C++ recursive solution to a Codeforces group problem: from a starting number, repeatedly branch and check whether the target value can be reached."
domain: cs
type: solution
status: raw
tags:
