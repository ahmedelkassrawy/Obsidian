---
description: "Explains forward declarations: declaring a function's signature before its body so callers above it compile, and the difference between a declaration and a definition."
domain: cs
type: concept
status: digested
tags:
