---
description: "NLP lecture 3: the sequence-modelling task types (one-to-many, many-to-one, many-to-many), a comparison of ANN vs CNN vs RNN, and an RNN deep dive."
domain: ml
type: course
status: digested
tags:
