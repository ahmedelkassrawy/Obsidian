---
description: "ML lecture 3: logistic regression as a classifier - the sigmoid mapping to probabilities, the decision boundary, and how it reuses the linear hypothesis."
domain: ml
type: course
status: digested
tags:
