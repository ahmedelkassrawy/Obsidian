---
description: "ML lecture 4: how decision trees split using Gini impurity and entropy/information gain with worked calculations, then Gaussian Naive Bayes."
domain: ml
type: course
status: digested
tags:
  ...
  - topic/statistics
aliases:
  - "ML4.Decision Trees & Naïve Bayes"
  - "ML4"
  - "Gini impurity"
