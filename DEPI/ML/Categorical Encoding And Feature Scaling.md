---
description: "ML lecture 2: encoding categorical data (one-hot vs label encoding and their dimensionality trade-off), then min-max normalization vs z-score standardization."
domain: ml
type: course
status: digested
tags:
