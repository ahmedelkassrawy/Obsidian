---
description: "ML lecture 8: distance metrics and centroids, the k-means loop and how to choose k, then DBSCAN's core, border and noise points and its advantages."
domain: ml
type: course
status: digested
tags:
