---
description: "Deep learning lecture 3: reusing pretrained models by freezing early layers and fine-tuning the last ones, hyperparameter tuning, early stopping and model checkpointing."
domain: ml
type: course
status: digested
tags:
