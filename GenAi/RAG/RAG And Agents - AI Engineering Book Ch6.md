---
description: "Chip Huyen Ch6 notes on RAG and agents: why context construction matters, the RAG architecture, term-based vs embedding-based retrieval, and how retrieval feeds agents."
domain: ai-eng
type: book
status: digested
tags:
