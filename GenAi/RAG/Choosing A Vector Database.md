---
description: "A decision framework for picking a vector database: scale brackets decide the shortlist, then cost vs operations, and the reminder that vector search alone always needs hybrid help."
domain: ai-eng
type: concept
status: digested
tags:
