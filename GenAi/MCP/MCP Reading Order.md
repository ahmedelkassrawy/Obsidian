---
description: "The reading order for the MCP notes, from concepts through building a server to the host side, plus how to tell which SDK version you are on."
domain: ai-eng
type: meta
status: digested
tags:
