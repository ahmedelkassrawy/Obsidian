---
description: "Pasted code for long-term memory in LangGraph: a Memory schema, Trustcall extractor, a store for across-thread memory alongside a checkpointer, and a spy to inspect the tool calls."
domain: ai-eng
type: howto
status: raw
tags:
