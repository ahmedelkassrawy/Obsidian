---
description: "The core LangGraph mental model - break the agent into nodes, describe the transitions, share state - plus error handling, retry policies and compiling with a checkpointer."
domain: ai-eng
type: concept
status: digested
tags:
