---
description: "Scratch notes on the coordinator/router shape in LangGraph: keeping next_step in state and using add_conditional_edges with a path map or Literal."
domain: ai-eng
type: howto
status: raw
tags:
