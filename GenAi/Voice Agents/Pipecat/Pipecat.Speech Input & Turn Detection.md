...
- This is more nuanced than simply detecting audio; 
- a brief pause doesn’t always mean the user is done talking.

Pipecat uses [user turn strategies](https://docs.pipecat.ai/server/utilities/turn-management/user-turn-strategies) to determine when user turns start and end.
...
---
#### User Turn Detection
- While VAD detects speech vs. silence, it can’t understand linguistic context. 
- A pause doesn’t mean the user is done. 
- User turn strategies interpret VAD signals and transcriptions to determine actual turn boundaries.
