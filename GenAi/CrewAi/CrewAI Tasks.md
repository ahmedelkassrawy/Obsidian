---
description: "Reference for CrewAI Tasks: execution flow, every task attribute, the TaskOutput object, accessing outputs after a crew run, and markdown output formatting."
domain: ai-eng
type: reference
status: digested
tags:
