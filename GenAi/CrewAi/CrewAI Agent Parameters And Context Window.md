---
description: "Pasted CrewAI code showing every Agent parameter, attaching tools, how CrewAI manages the context window with RAG and knowledge sources, and calling an agent directly with kickoff()."
domain: ai-eng
type: howto
status: raw
tags:
