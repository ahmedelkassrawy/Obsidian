---
description: "Why grep-based search makes a coding agent slow and inaccurate, and what enabling the Language Server Protocol gives Claude Code - self-correcting edits and on-demand code intelligence."
domain: ai-eng
type: howto
status: digested
tags:
