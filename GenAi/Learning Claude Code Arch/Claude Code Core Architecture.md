---
description: "Deep dive into Claude Code's architecture: what separates an agent from a chatbot, the tech stack and scale, the execution flow, core components and the key design patterns."
domain: ai-eng
type: concept
status: digested
tags:
