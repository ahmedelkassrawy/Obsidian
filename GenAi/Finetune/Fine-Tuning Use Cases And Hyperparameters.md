---
description: "When fine-tuning is the right call: real-world uses, whether it adds new knowledge, how it compares to RAG, and the hyperparameters that matter during training."
domain: ai-eng
type: concept
status: digested
tags:
