---
description: "Why sparse vectors waste dimensions and dense ones do not, then the progression from Word2Vec (word meaning) to transformers (context-aware tokens) to SBERT (one vector per sentence)."
domain: ai-eng
type: concept
status: digested
tags:
