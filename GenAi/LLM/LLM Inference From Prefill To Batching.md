---
description: "The two phases of inference - prefill reads the whole prompt, decode writes one token at a time - plus KV cache and static vs continuous batching."
domain: ai-eng
type: concept
status: digested
tags:
...
aliases:
  - "LLM Inference Concepts.From Prefill to Batching"
  - "prefill vs decode"
  - "continuous batching"
hubs:
  - "[[LLM Internals]]"
