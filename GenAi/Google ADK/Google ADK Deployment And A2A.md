---
description: "How ADK's to_a2a() wraps an agent in an A2A server with an auto-generated agent card, and how to serve and call it from another agent."
domain: ai-eng
type: howto
status: raw
tags:
