---
description: "ADK tool best practices: what the ToolContext parameter gives you (approval requests and state), and how to process the event stream a tool run produces."
domain: ai-eng
type: howto
status: digested
tags:
