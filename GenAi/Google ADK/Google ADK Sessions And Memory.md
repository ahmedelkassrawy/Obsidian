---
description: "Pasted ADK code for persistent sessions, context compaction, session state, and custom tools that read and write that state."
domain: ai-eng
type: howto
status: raw
tags:
