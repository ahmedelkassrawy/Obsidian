---
description: "Short pasted snippet showing how to attach ADK's LoggingPlugin to an InMemoryRunner for agent observability."
domain: ai-eng
type: howto
status: raw
tags:
  ...
  - topic/ai-evaluation
aliases:
  - "Google ADK. Agent Observability , Eval"
  - "LoggingPlugin"
hubs:
  - "[[Google ADK]]"
  - "[[Observability]]"
