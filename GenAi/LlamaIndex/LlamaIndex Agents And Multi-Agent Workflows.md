---
description: "Pasted LlamaIndex agent code: a basic FunctionAgent, running with a Context for state, setting Settings for LLM and embeddings, and defining a multi-agent workflow."
domain: ai-eng
type: howto
status: raw
tags:
