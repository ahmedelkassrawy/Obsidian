---
description: "The LlamaIndex RAG pipeline end to end: loading with readers, transformations and chunking, adding metadata and embeddings, and building the index."
domain: ai-eng
type: howto
status: digested
tags:
