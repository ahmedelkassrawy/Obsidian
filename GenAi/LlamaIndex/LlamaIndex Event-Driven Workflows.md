---
description: "Pasted LlamaIndex Workflow code: steps and typed events, start/stop events, running a workflow, concurrent state changes, typed state, and collecting multiple event types."
domain: ai-eng
type: howto
status: raw
tags:
