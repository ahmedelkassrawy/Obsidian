---
description: "Ch5 notes on orchestration: the common agent archetypes (reflex, ReAct, planner-executor, query-decomposition, reflection, deep research) and strategies for selecting tools."
domain: ai-eng
type: book
status: digested
tags:
