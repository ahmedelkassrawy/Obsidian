---
description: "Hub: every note about gRPC"
type: hub
domain: backend
tags:
  - type/hub
...
> [!info] One good note from HTTP/2 through protobuf to a working service. Missing: streaming modes and gRPC in production.
> Part of [[MOC - Backend]]. Also try the tag `#topic/grpc`.
